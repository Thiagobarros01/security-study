...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErroResposta> handleAccessDeniedException(AccessDeniedException e){
      ErroResposta err =  new ErroResposta(HttpStatus.FORBIDDEN.value(), "Acesso negado!", List.of());
